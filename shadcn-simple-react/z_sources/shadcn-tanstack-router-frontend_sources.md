...
<html lang="en">
  <head>
    ...
    <title>Create TanStack App - shadcn-simple-tanstack-router-react</title>
  </head>
  <body>
    <div id="app"></div>
...
```
{
  "name": "shadcn-simple-tanstack-router-react",
  "private": true,
  "type": "module",
  "scripts": {
    "dev": "vite --port 3000",
...
```
{
  "projectName": "shadcn-simple-tanstack-router-react",
  "mode": "file-router",
  "typescript": true,
  "tailwind": true,
  "packageManager": "bun",
