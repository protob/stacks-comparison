...
**Generated on:** nie, 16 lis 2025, 11:32:10 CET
**Root directory:** /home/dtb/0-dev/00-nov-2025/shadcn-and-simiar/crud-app-sqlite
...
## `frontend/src/utils/schema-helpers.ts`
```
import { z } from 'zod';
...
## `frontend/src/hooks/useItemFilters.ts`
```
...
## `backend/internal/common/slugify.go`
```
package common
...
## `backend/internal/common/fsutils.go`
```
package common
...
## `backend/internal/handlers/routing.go`
```
package handlers
