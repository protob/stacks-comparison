...
EXCLUDES=("node_modules" ".git" "dist" "build" ".output" ".nuxt" ".cache" "z_sources" "0_notes" "public" ".vite" "tmp")
...
# Main execution
echo "=== Project Source Code Consolidator ==="
